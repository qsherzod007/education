...
$sth = $conn->prepare('SELECT  *    FROM student limit :lim');
...
if (isset($_POST['firstName']) && !empty($_POST['firstName']) &&
    ...
    $sql = "update student set firstName = :firstName, lastName = :lastName, phoneNumber = :phoneNumber, region_id = :region_id where id = :id";
